 ...
 */
final class Version20221126215721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , focus VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_27BA704B4FCBBD7A FOREIGN KEY (lens_id) REFERENCES player (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
